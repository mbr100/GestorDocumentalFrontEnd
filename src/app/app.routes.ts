...
import {UsuariosComponent} from './pages/mantenimientos/gestionUsuarios/usuarios/usuarios.component';
...
export const routes: Routes = [
    ...
    { path: 'mantenimientos/usuarios', component: UsuariosComponent, canActivate: [authGuard]  },
